                        ...
                        <ul class="nav navbar-nav">
							...
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="jobs-change-password.html" class="dez-page">Change Password</a></li>
								</ul>
							</li>
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);" class="dez-page">Register <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
											<li><a href="create-account.html" class="dez-page">Employers Register</a></li>
											<li><a href="account-fresher.html" class="dez-page">Register Fresher</a></li>
											<li><a href="account-professional.html" class="dez-page">Register Professional</a></li>
										</ul>
									</li>
								</ul>
							</li>
							<li>
								...
								<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);" class="dez-page">Browse Job <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
											<li><a href="browse-job-list.html" class="dez-page">browse job list</a></li>
											<li><a href="browse-job-grid.html" class="dez-page">browse job grid </a></li>
											<li><a href="browse-job-filter-list.html" class="dez-page">browse filter list </a></li>
											<li><a href="browse-job-filter-grid.html" class="dez-page">browse filter grid </a></li>
										</ul>
									</li>
									<li><a href="javascript:void(0);" class="dez-page">Jobs<i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
											<li><a href="category-all-jobs.html" class="dez-page">all jobs</a></li>
											<li><a href="category-company-jobs.html" class="dez-page">company jobs</a></li>
											<li><a href="category-designations-jobs.html" class="dez-page">designations jobs</a></li>
											<li><a href="category-jobs.html" class="dez-page">category jobs</a></li>
											<li><a href="category-location-jobs.html" class="dez-page">location jobs</a></li>
											<li><a href="category-skill-jobs.html" class="dez-page">skill jobs</a></li>
										</ul>
									</li>									
									<li><a href="javascript:void(0);" class="dez-page">Portfolio <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
									...
									<li><a href="javascript:void(0);" class="dez-page">Login <i class="fa fa-angle-right"></i></a>
										<ul class="sub-menu">
