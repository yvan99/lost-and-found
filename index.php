            ...
            <div class="container">
                <div class="dez-bnr-inr-entry align-m">
					<div class="find-job-bx">
						 ...
						 <a href="javascript:void(0);" class="button-lg offset-3 btn-warning rounded mb-2">Documents recovery Management Information System</a> 
		...
		$(document).ready(function() {
			$("#search-box").keyup(function() {
				$.ajax({
					...
					beforeSend: function() {
						$("#search-box").css("background", "#FFF url(assets/homepage/images/gif/loading.gif) no-repeat 165px");
					},
